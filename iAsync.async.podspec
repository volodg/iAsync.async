#
#  Be sure to run `pod spec lint iAsync.async.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "iAsync.async"
  s.version      = "0.0.1"
  s.summary      = "iAsync.async lib developed to make async programming easier"
  ...
  s.source = { :git => "https://github.com/volodg/iAsync.async.git", :tag => "0.0.1" }
